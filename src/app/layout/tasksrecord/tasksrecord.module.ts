...
import {TasksRecordRoutingModule} from './tasksrecord-routing.module'
...
@NgModule({
  imports: [CommonModule, MatCommonModule,TasksRecordRoutingModule, PageHeaderModule
...
export class TasksRecordModule {}
